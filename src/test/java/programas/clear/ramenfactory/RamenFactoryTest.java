...
public class RamenFactoryTest extends BaseTest {
    ...
    public void name3() {
        ...
        softly.assertThat(ramenFactory.solution(4, new int[]{4, 10, 11, 12, 13, 14}, new int[]{11, 3, 2, 5, 1, 6}, 27))
                .isEqualTo(4);
    ...
    public void name4() {
        ...
        softly.assertThat(ramenFactory.solution(4, new int[]{1, 2, 3, 4}, new int[]{10, 40, 30, 20}, 100))
                .isEqualTo(4);
    }
